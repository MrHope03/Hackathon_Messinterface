...
tk.Label(main, text='f{inf}\'s menu: ', font=1500).grid(row=4, column=30)
...
tk.Label(main, text='Have a great day!!!', font=500).grid(row=14, column=40)
button3 = tk.Button(main, text='SUBMIT', width=25, command=getvalues)
button3.grid(row=15, column=35)
